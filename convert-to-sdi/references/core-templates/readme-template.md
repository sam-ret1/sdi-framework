...
- **Roo Code / Kilo Code / OpenCode.** Configure the `sdi-mode` custom mode/agent following the appropriate adapter. Once active, paste the kickoff prompt from the current `IMPLEMENTATION_PLAN_*.md` to start the work item.
