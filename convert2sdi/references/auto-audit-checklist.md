...
- If `AGENTS.md` already exists with **compatible** SDI structure → propose **skipping** convert2sdi entirely (project is already framework-adopted; only update if structure has drifted).
...
> Generated by convert2sdi Phase 0 auto-audit. Confirm or correct in Phase 1.
